...
const why = [
  ...
  { title: "Dedicated Support", body: "24/7 multilingual support for clients and partners.", icon: Headphones },
];
      ...
      <section id="about-us" className="bg-navy py-20 text-white">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-3">
            {["100+ Instruments", "24/7 Support", "Global Client Base"].map((stat) => <div key={stat} className="rounded-md bg-white/10 p-5 text-center font-semibold">{stat}</div>)}
          </div>
        </div>
      </section>
